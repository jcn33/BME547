### Practice with increasing code modularity
#Reusable
#Readable
#Testable
...
def dosage_calc(weight, diagnosis):
...
def dose_amount():
    ...
    # Initial choosing of diag. type
    diagnosis = diagnosis_type()

    #Enter patient weight info
    weight = patient_info()
    
    #Dosage output
    dosage_calc(weight, diagnosis)
